#ifndef MEMSTOREUINTBPLUSTREE_H
#define MEMSTOREUINTBPLUSTREE_H
...
*/
namespace leveldb {
class MemstoreUint64BPlusTree: public SecondIndex{
...
//					checkConflict(new_sibling, 1);
				...
				toInsert->num_keys++;
				toInsert->keys[k] = reinterpret_cast<InnerNode*>(child)->keys[IN-1];
